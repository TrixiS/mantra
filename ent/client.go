...
import (
	...
	"github.com/TrixiS/mantra/ent/migrate"
...
// QueryOwner queries the owner edge of a Connection.
func (c *ConnectionClient) QueryOwner(co *Connection) *UserQuery {
...
type (
	hooks struct {
		Connection, User []ent.Hook
	}
	inters struct {
		Connection, User []ent.Interceptor
	}
)
